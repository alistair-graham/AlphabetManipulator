...
public class DiamondAlphabetServiceTests
{
    ...
    public void CreateFromChar_LetterA_ReturnsA()
    {
        ...
        var result = _diamondAlphabetService.CreateFromChar(LETTER_A);
    ...
    public void CreateFromChar_LetterM_ReturnsDiamondUpToLetterM()
    {
        ...
        var result = _diamondAlphabetService.CreateFromChar(LETTER_M);
    ...
    public void CreateFromChar_LetterZ_ReturnsFullDiamond()
    {
        ...
        var result = _diamondAlphabetService.CreateFromChar(LETTER_Z);
    ...
    public void CreateFromChar_LowerCaseB_ReturnsUpperCaseDiamond()
    {
        ...
        var result = _diamondAlphabetService.CreateFromChar(LOWERCASE_B);
...
B B
 A ";
    ...
    [Fact]
    public void CreateFromChar_NonAlphabeticalCharacter_ReturnsEmptyString()
    {
        const char NON_ALPHABETICAL_CHARACTER = '?';

        var result = _diamondAlphabetService.CreateFromChar(NON_ALPHABETICAL_CHARACTER);
